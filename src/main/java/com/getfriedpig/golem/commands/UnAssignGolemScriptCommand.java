...
import com.getfriedpig.golem.ai.components.ScriptRemovedComponent;
...
public class UnAssignGolemScriptCommand  extends AbstractPlayerCommand {
    private final RequiredArg<Integer> golemNumber;

    public UnAssignGolemScriptCommand() {

        super("stopg", "Give a golem a file to run");
    ...
    protected void execute(@Nonnull CommandContext commandContext,
        ...
        golemStore.addComponent(golemRef, ScriptRemovedComponent.getComponentType());
    }
}
